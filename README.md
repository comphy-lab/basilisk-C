...
- **Local Visualization Server**: Offline 3D visualization using a [local bview client](https://github.com/comphy-lab/bview-local-client) (manual URL works without patches; optional `--local-bview` or `--comphy-bview` installer flags are mutually exclusive — see `Tips.md`)
