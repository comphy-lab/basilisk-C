/**
*This is a slight modification of diffusion.h, essentially adding calls to boundary after modifications of some fields. This modification is mandatory if non-cartesian metrics are involved.*
*/
