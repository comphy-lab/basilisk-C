/**
# Poisson Solver 4th Order Scheme on an Adaptive Grid

The fourth order Poisson scheme is used to solve a familiar compact function case with Neumann Boundary Conditions.
