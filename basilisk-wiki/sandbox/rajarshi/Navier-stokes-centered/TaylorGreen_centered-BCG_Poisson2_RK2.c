/**
Taylor green vortex - RK2 time stepping + bcg advection + Order 2 (Viscous term and Projection)
*/

#include "grid/multigrid.h"
#include "centered-bcg-PoissonO2-rk2.h"
...
![Animation of the pressure field.](TaylorGreen_centered-BCG_Poisson2_RK2/Pressure.mp4)

![Animation of the kinetic energy field.](TaylorGreen_centered-BCG_Poisson2_RK2/Kinetic-Energy.mp4) 
