...
double (* Reconstruction_Left)  (Point, scalar *, double) = WENO5L;
double (* Reconstruction_Right) (Point, scalar *, double) = WENO5R;
...
~~~gnuplot Kinetic Energy at a particular crest point (Variation with Time)
set output 'Kinetic_Energy-WENO5.png'
set xlabel 'time'
set ylabel 'KE(time)'
set grid
plot 'KE_Location-Display.dat' u 1:2 w p t 'KINETIC ENERGY WENO5'
~~~

~~~gnuplot Potential Energy at a particular crest point (Variation with Time)
set output 'Potential_Energy-WENO5.png'
set xlabel 'time'
set ylabel 'PE(time)'
set grid
plot 'PE_Location-Display.dat' u 1:2 w p t 'POTENTIAL ENERGY WENO5'
~~~

~~~gnuplot Total Energy at a particular crest point (Variation with Time)
set output 'Total_Energy-WENO5.png'
set xlabel 'time'
set ylabel 'TE(time)'
set grid
plot 'TE_Location-Display.dat' u 1:2 w p t 'TOTAL ENERGY WENO5'
~~~
...
set xlabel 'Delta'
set ylabel '|| T(Delta) - T-Analytical(Delta) ||'
set grid
