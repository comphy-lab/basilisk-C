/**
## 1D Test case of 2nd Order Laplacian operator on a Uniform Grid

In this code the error scaling of the Laplacian operator has been demonstrated. A compact function which includes a polynomial function of order 10 is used.
*/
...
/**
## Results
~~~gnuplot Error Distribution of the 2nd order Laplacian scheme on a homogenous grid
...
~~~gnuplot Error Scaling of the Laplacian 2nd order scheme
