...
In this code the error scaling of the Laplacian operator has been demonstrated on a Uniform Grid. A compact function which includes a polynomial function of order 8 is used.
*/
