int main()
{
  system ("wget https://basilisk.fr/sandbox/nlemoine/SWE/diffwave/fullsaintvenant/h.mp4 -O h_full.mp4 && "
          "wget https://basilisk.fr/sandbox/nlemoine/SWE/diffwave/diffwave/h.mp4 -O h_diffwave.mp4 && "
