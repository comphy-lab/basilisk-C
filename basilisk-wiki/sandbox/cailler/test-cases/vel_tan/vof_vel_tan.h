...
/**
## New fields for normal computation at boundaries

We need to allocate two new fields for the computation 
of normals at the interface crossing borders: one for 
the normal vector itself, and one for the related intercept.
*/
...
This is where the normal vector at the interface crossing 
