...
please refer to [this page](/sandbox/cailler/keller_miksis/keller_fig2_all.c).
...
for the [full study](/sandbox/cailler/keller_miksis/keller_fig2_all.c) 
...
Unfortunately, due to [a specific bug](/sandbox/bugs/successive_runs.c), 
...
[`vof_keller_fig2.h`](/sandbox/cailler/keller_miksis/vof_keller_fig2.h)).
