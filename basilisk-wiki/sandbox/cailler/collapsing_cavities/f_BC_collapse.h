...
double f_BC_left(double ff0, double ff1, double ff2){
  ...
  if ((ff0 > 0.0) && (ff0 < 1.0)){
    ...
    return rectangle_fraction (ntemp, alpha_temp, (coord){-1.5,-0.5}, (coord){-0.5,0.5});
  }
  ...
  if ((ff1 > 0.0) && (ff1 < 1.0)){
    ...
    return rectangle_fraction (ntemp, alpha_temp, (coord){-1.5,-1.5}, (coord){-0.5,-0.5});
  }
  ...
  if ((ff2 > 0.0) && (ff2 < 1.0)){
    ...
    return rectangle_fraction (ntemp, alpha_temp, (coord){-1.5,0.5}, (coord){-0.5,1.5});
  }
...
double f_BC_top(double ff0, double ff1, double ff2){
  ...
  if ((ff0 > 0.0) && (ff0 < 1.0)){
    ...
    double alpha_temp = plane_alpha (ff0, ntemp);
    return rectangle_fraction (ntemp, alpha_temp, (coord){-0.5,0.5}, (coord){0.5,1.5});
  }
  ...
  if ((ff2 > 0.0) && (ff2 < 1.0)){
    ...
    double alpha_temp = plane_alpha (ff2, ntemp);
    return rectangle_fraction (ntemp, alpha_temp, (coord){0.5,0.5}, (coord){1.5,1.5});
  }
...
double f_BC_bottom(double ff0, double ff1, double ff2){
  ...
  if ((ff0 > 0.0) && (ff0 < 1.0)){
    ...
    double alpha_temp = plane_alpha (ff0, ntemp);
    return rectangle_fraction (ntemp, alpha_temp, (coord){-0.5,-1.5}, (coord){0.5,-0.5});
  }
  ...
  if ((ff2 > 0.0) && (ff2 < 1.0)){
    ...
    double alpha_temp = plane_alpha (ff2, ntemp);
    return rectangle_fraction (ntemp, alpha_temp, (coord){0.5,-1.5}, (coord){1.5,-0.5});
  }
