/**
# SELF-SIMILAR Bell-Colella-Glaz advection scheme (1st Huppert problem)
		    ...
		    (const) scalar src)
{
  ...
  foreach_face() {
    ...
    $\textcolor{Orchid}{
      ...
      = \overline{\mathbf{u}} + \, \boldsymbol{\xi}
    }$
    with $\boldsymbol{\xi} = {}^{\mathrm{t}}(- \xi, \, \eta) / 5$.
    Then:
