/**
# SELF-SIMILAR Bell-Colella-Glaz advection scheme (Stokes first problem)
		    ...
		    (const) scalar src)
{
  ...
  foreach_face() {
    ...
    for building a self-similar solver,
    ...
    + \overline{g}_d^n 
    \textcolor{green}{ + \dfrac{1}{2} \, \overline{u}_d^n}    
    $$
