/**
# Self-similar centered Navier--Stokes solver ([*Lamb--Oseen* vortex](/sandbox/cailler/lamb_oseen/lamb.c))
...
[advection scheme](/sandbox/cailler/lamb_oseen/selfsim_bcg_lamb.h) 
