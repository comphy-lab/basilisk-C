/**
This file is the same as navier-stokes/centered.h except that it includes viscosity-embed_perso.h instead of viscosity-embed.h
...
#include "bcg.h"
#if EMBED
#include "viscosity-embed_perso.h"
#else
# include "viscosity.h"
#endif
