...
double initial_width = 1.460034246173698591e-3 [0, 1, 0], initial_height = 1.580031645252714556e-3 [0, 1, 0];
double radius = 0.760016473e-3 [0, 1, 0];
...
double freq = 180.0 [0, 0, -1], amp = 0.114e-3 [0, 1, 0];
...
event logfile(t += TOUT, t <= TEND)
{
  ...
  fprintf(fp3, "%-12g %-12g %-12g %-12g %-12g %-12g\n",
          t, STAGE_VEL(t), STAGE_ACC(t), uc, vc, rho1*sq(uc)*1./1.);
  fprintf(fp4, "%-12g %-12g %-12g %-12g %-12g %-12g\n",
          t*T_unit, stage_vel(t), stage_acc(t), U_unit*uc, U_unit*vc, rho_1*sq(U_unit*uc)*radius/sig);
