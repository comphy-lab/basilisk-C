/**
# Embedded boundaries (with a fix for update_tracers metrics)

See the related bug report [here](https://basilisk.fr/sandbox/bugs/axi_embed_tracers.c). 
...
void update_tracer (scalar f, face vector uf, face vector flux, double dt)
{
  ...
  // In the current state, the process is not conservative ! 
}
