...
event init (i = 0) {
  if (divq_rad == optically_thin) {
    ...
    otm.indexCO2 = OpenSMOKE_IndexOfSpecies ("CO2");
    otm.indexH2O = OpenSMOKE_IndexOfSpecies ("H2O");
    otm.indexCO  = OpenSMOKE_IndexOfSpecies ("CO");
    otm.indexCH4 = OpenSMOKE_IndexOfSpecies ("CH4");
