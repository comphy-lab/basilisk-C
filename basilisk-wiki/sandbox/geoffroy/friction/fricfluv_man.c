/**
# Friction in saint-venant : Fluvial Test case with Manning
...
/**
## Declarations
We call the saint venant solver in 1D and we add the Manning's friction term as a source term.*/
...
int ne = 0;
double pause, tmax, q0 = 1.5, z0, zf, h0, tb = 2000;
...
We fix h and u at both boundaries (fluvial case).*/
...
![Error convergence](/fluv_man_error.png)

![Error t](/fluv_man_errt.png)

![Water depth profiles](/fluv_man_height.png)
