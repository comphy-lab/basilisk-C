/**
# Friction in saint-venant : Fluvial Test case with Darcy
...
We call the saint venant solver in 1D and we add the
Darcy's friction term as a source term.*/
...
int ne = 0;
double pause, tmax, q0 = 1.5, z0, zf, h0, tb = 1000;
...
![Error convergence](/fluv_darcy_error.png)

![Error time](/fluv_darcy_errt.png)

![Water depth profile](/fluv_darcy_height.png)
*/
/**
## References 
