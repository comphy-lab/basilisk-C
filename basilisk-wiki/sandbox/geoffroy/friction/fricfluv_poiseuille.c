/**
# Friction in saint-venant : Fluvial Test case with Poiseuille
...
/**
## Declarations
We call the saint venant solver in 1D and we add the Poiseuille friction term as a source term.*/
...
int ne = 0;
double pause, tmax, q0 = 1.5, z0, zf, h0, tb = 5500;
...
We fix h and q at both boundaries (fluvial case). We also fix zb condition.*/
...
![Error convergence](/fluv_pois_error.png)
 
![Error time](/fluv_pois_errt.png)
 
![Height](/fluv_pois_height.png)
