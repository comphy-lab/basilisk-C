/**
# Friction in saint-venant : Torrential test case with Darcy
...
![Error convergence](/tor_darcy_error.png)

![Error time](/tor_darcy_errt.png)

![Water depth profile](/Height.png)
