...
the shape of a torus unknot, $\mathcal{U}_{p,1}$, which is can be seen as a
helical coil wrapped around a torus with a single poloidal revolution and p
toroidal revolutions. We can also think of this curve as a thin vortex ring
superimposed with a Kelvin wave of azimuthal wavenumber $m=p$ and
finite-amplitude. Here, we consider 3 cases with $p=2$, $p=4$ and $p=8$, and
equal amplitude $A=0.15R$ of the Kelvin wave, where $R$ is the radius of the
undeformed vortex ring. The shape of the vortex filaments are shown below.

![Steady vortex filaments in the shape of a torus unknot, $\mathcal{U}_{2,1}$, 
$\mathcal{U}_{4,1}$, and $\mathcal{U}_{8,1}$](./helical_rings_A015/prescribed_curve1.png){width=75%}
...
<div style="text-align: center;">
  <video controls style="width: 75%; max-width: 100%; height: auto; margin: 0 auto;">
    <source src="./helical_rings_A015/top_view.mp4" type="video/mp4">
...
<div style="text-align: center;">
  <video controls style="width: 75%; max-width: 100%; height: auto; margin: 0 auto;">
    <source src="./helical_rings_A015/side_view.mp4" type="video/mp4">
    Your browser does not support the video tag.
  </video>
</div>
*/
...
Viewed from the top, the vortex filaments look like planar curves, but are actually 3D curves. 
