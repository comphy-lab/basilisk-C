...
GROUPS = {
  ...
  'spectra': ([('test_spectra_sample', 'octree'),
               ...
               ('test_spectra_cross', 'octree'),
               ('test_spectra_cross', 'multigrid3D'),
               ('test_spectra_foliate_sample', 'octree'),
               ('test_spectra_foliate_sample', 'multigrid3D'),
               ('test_spectra_foliate', 'octree'),
               ('test_spectra_foliate', 'multigrid3D'),
