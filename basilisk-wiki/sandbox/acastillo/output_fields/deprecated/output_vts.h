/*
This function writes one XML VTK file per PID process of type structured grid
(*.vts) which can be read using Paraview. File stores scalar
...
*/
void output_vts_ascii (scalar * list, vector * vlist, int n, FILE * fp, bool linear)
{
...
*/
void output_vts_bin (scalar * list, vector * vlist, int n, FILE * fp, bool linear)
{
  fputs ("<?xml version=\"1.0\"?>\n"
  "<VTKFile type=\"StructuredGrid\" version=\"1.0\" byte_order=\"LittleEndian\" header_type=\"UInt64\">\n", fp);
  fprintf (fp,"\t <StructuredGrid WholeExtent=\"0 %d 0 %d 0 %d\">\n", N-1, N-1, 0);
