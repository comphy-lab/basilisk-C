...
/** ### Populate points_dset for facets in xdmf, within a box (interleaved) */
trace
void populate_points_dset_facets_xdmf_box(scalar c, coord box[2], double **points_dset, long num_points, long *offset_points, hsize_t *count, hsize_t *offset) {
  count[0] = num_points;
  count[1] = 3;
  offset[0] = 0;
  offset[1] = 0;
...
/** ### Populate topo_dset for facets in xdmf, within a box (Mixed Topology) */
trace
void populate_topo_dset_facets_xdmf_box(scalar c, coord box[2], long **topo_dset, long topo_size, long *offset_topo, long *offset_points, hsize_t *count, hsize_t *offset) {
  count[0] = topo_size;
  count[1] = 1;
  offset[0] = 0;
  offset[1] = 0;
...
trace
void populate_scalar_dset_facets_xdmf_box(scalar c, coord box[2], scalar s, double *scalar_dset, long num_cells, long *offset_cells, hsize_t *count, hsize_t *offset) {
  count[0] = num_cells;
  count[1] = 1;
  offset[0] = 0;
  offset[1] = 0;
