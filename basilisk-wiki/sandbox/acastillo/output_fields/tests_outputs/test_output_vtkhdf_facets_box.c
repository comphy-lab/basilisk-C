/**
# Testing `output_facets_vtkhdf_box()`
...
int main(){
  ...
  #endif
  output_facets_vtkhdf_box(f, kappa, "Interface_vtkhdf_box.hdf", box);
  ...
  `test_output_vtkhdf_facets_box.ref`. */
  if (pid() == 0)
    system ("python3 ../test_output_vtkhdf.py --cardioid "
            "--box=0,-1,1,1 Interface_vtkhdf_box.hdf 1>&2");
}
