...
/**
We set the frequency to kill with the SFD method. */
double freq_SFD = 0.25;

/**
The SFD will activate at t = 30. */
bool SFD_toggle;
...
event movies (t = 30; t += 0.25; t <= Tend)
{
...
event adapt (i++) {
  astats s = adapt_wavelet ({cs,u}, {1e-2,0.02,0.02,0.02}, maxlevel, 4);
