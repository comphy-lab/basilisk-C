...
In this file, I modify the acceleration vector field to impose a pressure gradient in the channel. 
*/
...
event init (t = 0) {
  ...
  /**
  The viscosity is unity and the gravity vector acts as $\Delta P / L$*/
  
  const face vector g[] = {(double) N, 0.};
