...
of the two-phase cells in the three-phase flow is modified.
Therefore, the include of the fraction.h shall be modified to
*fractions-3p.h* and the rest remains the same. */
