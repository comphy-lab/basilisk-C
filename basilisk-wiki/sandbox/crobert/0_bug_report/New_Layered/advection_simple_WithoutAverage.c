...
In this file, the slope-weighted sum in nh.h is turned off. Only rhsf is used.
![Animation of the free-surface](advection_simple_WithoutAverage/movie.mp4)
*/

#include "grid/multigrid1D.h"
#include "layered/hydro.h"
#include "nh_WithoutAverage.h"
