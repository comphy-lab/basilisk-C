...
/**
## Geometry */
#define L 600.           // size of the box
#define T_END 7000
#define LEVEL 9          //horizontal resolution
...
*/
  foreach(){
//    double H = shape[(ne)][1];
    double H = ne<(512-128) ? shape[0][1] : shape[ne-(512-128)][1];
    ne++;    
    Hi[] = H;
    foreach_layer() {
      h[] = H/nl;
