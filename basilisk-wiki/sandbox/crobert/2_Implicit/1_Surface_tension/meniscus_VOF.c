...
We show here an example of Quentin Magdelaine using an integral formulation of
 the surface tension force, as depicted in
...
![Pressure field](meniscus_VOF/pressure.mp4)

![Horizontal velocity field](meniscus_VOF/u_x.mp4)
...
#define Yc (1. + Rf*sin(liquid_theta))
