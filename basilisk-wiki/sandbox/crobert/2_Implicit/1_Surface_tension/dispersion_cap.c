/**  
# Dispersion relations of pure capillary waves with implicit surface tension implementation
...
We use a 1D grid, the implicit multi-layer solver with surface tension. */
