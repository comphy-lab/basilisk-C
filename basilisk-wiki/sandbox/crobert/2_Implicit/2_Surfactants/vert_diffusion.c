...
Solute diffusion answers to a Fick diffusion equation of a specie with a
 concentration $c$.
$$
\frac{\partial c}{\partial t} =\nabla^2 c 
$$
In this minimum working example, this equation is solved vertically with a
 Dirichlet boundary condition at the bottom and a Neumann boundary
