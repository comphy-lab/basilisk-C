...
*/
  ...
  double x_inlet,x_outlet,Dx_inlet,y_inlet,y_outlet,Dx_outlet;


  double C1,C2,C3,WIDTH,CBE1,CBE2,LENGTH,C56;
...
/**
#    Culvert modelling
![Fig. 1: source-term coupling approach (green: $p$ inlet cells, purple: $p$ outlet cells, the culvert discharge is equally divided into each cells $\frac{Q_{c}}{p}$). ](https://media.springernature.com/lw685/springer-static/image/chp%3A10.1007%2F978-981-19-1600-7_8/MediaObjects/523064_1_En_8_Fig3_HTML.png)
...
![Fig. 2: Flow types](https://media.springernature.com/lw685/springer-static/image/chp%3A10.1007%2F978-981-19-1600-7_8/MediaObjects/523064_1_En_8_Fig1_HTML.png)
...
/**
This function can be used to retrieve the flow type: 
*/

double culvert_FT (struct culvert c){
