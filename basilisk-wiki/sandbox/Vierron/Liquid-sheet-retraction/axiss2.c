...
/**
## Mesh adaptation
We use an adaptive mesh ([Adaptation Algorithm](/sandbox/Antoonvh/the_adaptive_wavelet_algorithm)) with a maximum level of refinement of MAXLEVEL. We adapt the mesh with respect to the interface and the velocity (u.r ; u.z).*/
