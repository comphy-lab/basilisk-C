...
attribute {
  ...
  double cdi; // uniform concentration in the gas phase for each time step i (a function of laplace pressure)S
...
event tracer_advection (i++)
{
  ...
  */
  ...
  // ***consider the effect of laplace pressure on the saturation concentration***//
  //#ifdef LAPLACE_PRESSURE 
  double bc = tr_c.cdi/tr_c.He; //Henry's Law
 // double rho2_laplace = tr_c.cdi*tr_c.mol_mass;
  m_i[] = -concentration_gradient (point, tr_c, f, d, n, p, bc, third)*tr_c.mol_mass*tr_c.D/(1-rho2/rho1); //Fix me. Add 1-\rho_{c_c}/\rho_c term
  //#else
  //double bc = tr_c.cd/tr_c.He; //Henry's Law
  //m_i[] = -concentration_gradient (point, tr_c, f, d, n, p, bc, third)*tr_c.mol_mass*tr_c.D/(1-rho2/rho1); //Fix me. Add 1-\rho_{c_c}/\rho_c term
  //#endif
...
@phdthesis {magdelaine2019,
  title = {Hydrodynamics of liquid films hétérogènes},
