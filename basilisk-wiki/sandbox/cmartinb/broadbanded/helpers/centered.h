...
event init (i = 0)
{
  fprintf (stderr, "projection t = %.10e %.10e %.10e\n",t,tnext,dt);
  trash ({uf});
  foreach_face()
  ...
  dtmax = DT;
  fprintf (stderr, "Before stab: tnext,t,dtmax,dt = %.10e %.10e %.10e %.10e\n",tnext,t,dtmax,dt);
  event ("stability");
  fprintf (stderr, "After  stab: tnext,t,dtmax,dt = %.10e %.10e %.10e %.10e\n",tnext,t,dtmax,dt);
}
...
event set_dtmax (i++,last) {
  fprintf (stderr, "Before dtmax: tnext,t,dtmax,dt = %.10e %.10e %.10e %.10e\n",tnext,t,dtmax,dt);
  dtmax = DT;
  fprintf (stderr, "After  dtmax: tnext,t,dtmax,dt = %.10e %.10e %.10e %.10e\n",tnext,t,dtmax,dt);
}

event stability (i++,last) {
  fprintf (stderr, "Before dtnext: tnext,t,dtmax,dt = %.10e %.10e %.10e %.10e\n",tnext,t,dtmax,dt);
  dt = dtnext (stokes ? dtmax : timestep (uf, dtmax));
  fprintf (stderr, "After  dtnext: tnext,t,dtmax,dt = %.10e %.10e %.10e %.10e\n",tnext,t,dtmax,dt);
}
...
{
  fprintf (stderr, "advection_term t = %.10e %.10e %.10e\n",t,tnext,dt); 
  if (!stokes) {
    prediction();
