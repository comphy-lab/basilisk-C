/**
This code is from [Palas Farsoya](/sandbox/farsoiya/README). The relevant publication is [Farsoiya et al., 2024](#farsoiya2024).

The minor changes are:

1. commenting out of minmod3 function (as this is used in src/redistance.h, called by src/two-phase-clsvof.h)

2. redistance function renamed redistance2 (as redistance is used in src/redistance.h)
