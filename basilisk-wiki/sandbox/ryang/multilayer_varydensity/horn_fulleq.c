...
plot '../horn.horn' u 1:($2*100.) index 'ai = 0.01305' w l t 'Horn 2001', \
     ...
     '/home/basilisk-src/basilisk/src/test/horn.ref' u 1:($2*100.) index 'ai = 0.01305' w l t 'basilisk (reference)'
unset key
plot '../horn.horn' u 1:($2*100.) index 'ai = 0.0261' w l t 'Horn 2001', \
     'log' u 1:($2*100.) index 'ai = 0.0261' w l t 'basilisk', \
     '/home/basilisk-src/basilisk/src/test/horn.ref' u 1:($2*100.) index 'ai = 0.0261' w l t 'basilisk (reference)'
plot '../horn.horn' u 1:($2*100.) index 'ai = 0.03915' w l t 'Horn 2001', \
     'log' u 1:($2*100.) index 'ai = 0.03915' w l t 'basilisk', \
     '/home/basilisk-src/basilisk/src/test/horn.ref' u 1:($2*100.) index 'ai = 0.03915' w l t 'basilisk (reference)'
plot '../horn.horn' u 1:($2*100.) index 'ai = 0.0522' w l t 'Horn 2001', \
     'log' u 1:($2*100.) index 'ai = 0.0522' w l t 'basilisk', \
     '/home/basilisk-src/basilisk/src/test/horn.ref' u 1:($2*100.) index 'ai = 0.0522' w l t 'basilisk (reference)'
plot '../horn.horn' u 1:($2*100.) index 'ai = 0.0783' w l t 'Horn 2001', \
     'log' u 1:($2*100.) index 'ai = 0.0783' w l t 'basilisk', \
     '/home/basilisk-src/basilisk/src/test/horn.ref' u 1:($2*100.) index 'ai = 0.0783' w l t 'basilisk (reference)'
unset multiplot
~~~
...
double * rho = (double []){ 1.018, 1. [-3,0,1] };
...
int main()
{
  ...
  /**
  <div class="message">The code is unstable for DT = 0.05 this is not the case for the 
  original test case</div> */
