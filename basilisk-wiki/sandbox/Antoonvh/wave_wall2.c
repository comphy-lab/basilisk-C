...
This page is a near copy of the marvalous page presented in Stephane
Popinet's sandbox: [wave.c](../popinet/wave.c). I am indebted to the
contributors here.
...
initialisation. We also set a no-slip contion to at the right wall */
...
int main (int argc, char * argv[])
{
  ...
  $L0=1$, periodic in the optional z-direction. */
...
We use Basilisk view to display animations of the
results. */
...
The wave period is `k_/sqrt(g_*k_)`. We want to run up to 0.4
 periods. */
