...
tendency for the diffusion equation, $$\frac{\partial s}{\partial t} =
\nabla^2 s,$$ for a Gaussian blob.

~~~gnuplot L_2 error norm
set logscale x 2
set logscale y
...
![$\approx 30^2$ cells,](diffusion_error/s889.png)

![$\approx 344^2$ cells.](diffusion_error/s118030.png)
