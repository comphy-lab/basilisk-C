/**
# $\lambda_2$ criterion in 2 and 3 dimensions

This is a slight modification of [lambda2.h](/src/lambda2.h) so that it also functions in 2 dimensions */
...
{
  foreach() {
    double JJ[dimension][dimension] = {0};
    scalar s = u.x;
    int i = 0;
    foreach_dimension()
