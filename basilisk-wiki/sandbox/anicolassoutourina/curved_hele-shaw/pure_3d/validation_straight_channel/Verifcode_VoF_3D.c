...
const double bubble_init_x = x_offset ; // WARNING : cannot divide by any variable while initializing constants
...
const double t_max = 3.5 ; // max time the simulation will run for (in s)
