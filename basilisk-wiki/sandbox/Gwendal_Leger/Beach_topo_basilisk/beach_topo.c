...
/**
We can choose among different waves :
...
*/
#define wave_choice 7 // Type of wave (1 = square; 2 = sinus; 3 = pointy hat; 4 = pointy sinus; 5 = full sinus; 6 = parabola; 7 = C^oo_o; <0 = soliton)
