/**
# Two drops kiss critical test case
The test case is token from [Yu et al, 2019](#yu_versatile_2019)

![Time evolution of the interface with sigma12 = sigma31 = 0.6.](two_drop_kiss/movie.mp4)
