...
#include "correction/three-phase_cor.h"
#include "tension.h"
#include "norm-3p.h"
#include "view.h"
...
event logfile (t=end){
  coord p1, p2;
  double d1 = locate_triple_point(&p1, f1, f2, f3, -L/2., 0., -L/2., L/2., 1.1);
  double d2 = locate_triple_point(&p2, f1, f2, f3, 0., L/2., -L/2., L/2., 1.1);
  output_cells(stdout);
