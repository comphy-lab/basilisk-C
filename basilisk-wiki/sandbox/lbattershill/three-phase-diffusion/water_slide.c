...
/**
We output the water elevation profile. Note: at the moment, I have Python code to implement wave gauges. A little tricky due to rotated domain.. */
int add = 0;
...
/**Option to hash this out- vtu files not necessary.  */ 
