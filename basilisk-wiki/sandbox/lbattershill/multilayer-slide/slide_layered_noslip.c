/**
# Tsunami generation by a "pyroclastic" density current- NO SLIP CASE

*Note: this is unstable* 

This is a simulation of a pyroclastic density current entering water
and generating tsunami waves. We simulate a dense layer at base of flow, overlayed by a lighter layer. The setup is dimensionless and based on the experimental
...
![Closeup view: the colorscale is the relative density
 variation.](slide_layered_noslip/movie_closeup.mp4)(autoplay loop width="100%")

![Full tank view: the colorscale is the relative density
 variation.](slide_layered_noslip/movie_normal.mp4)(autoplay loop width="100%")
*/
