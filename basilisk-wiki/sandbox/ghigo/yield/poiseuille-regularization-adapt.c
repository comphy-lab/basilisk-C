...
#include "src/yield-regularization.h"
#include "view.h"
...
![*u.x* velocity field](poiseuille-regularization-adapt/ux.png)
...
plot 'out' u 1:3 w p ps 0.75 pt 6 lc rgb "black" t "Exact", \
     'out' u 1:2 w l lw 2 lc rgb "blue" t 'Regularization, adapt'
~~~
...
plot 'out' u 1:5 w p ps 0.75 pt 6 lc rgb "black" t "Exact", \
     'out' u 1:4 w l lw 2 lc rgb "blue" t 'Regularization, adapt'
~~~
...
plot 'log' u 1:4 t '|h|_{max}' ps 1.5, \
