...
![*u.x* velocity field](poiseuille-regularization/ux.png)
...
plot 'out' u 1:3 w p ps 0.75 pt 6 lc rgb "black" t "Exact", \
     'out' u 1:2 w l lw 2 lc rgb "blue" t 'Regularization, mg'
~~~
...
plot 'out' u 1:5 w p ps 0.75 pt 6 lc rgb "black" t "Exact", \
     'out' u 1:4 w l lw 2 lc rgb "blue" t 'Regularization, mg'
~~~
