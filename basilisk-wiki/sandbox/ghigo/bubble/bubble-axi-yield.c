/**
# Axisymmetric rising Newtonian bubble in a Bingham fluid */
...
described in (two-phase.h)[two-phase.h]. However, in case of a yielded
fluid, we need to modify the viscosity of fluid 1 to account for
...
![*u.x* velocity field and mesh levels](bubble-axi-yield/bubble.mp4)

![VOF interface and yield criteria (0 yielded, 1 unyielded)](bubble-axi-yield/yield.mp4)

~~~gnuplot Time evolution of the bubble speed
set key top left spacing 1.1
set xlabel "t"
set ylabel "u"
plot "../bubble-axi/log" u 3:6 w l lw 2 lc rgb "blue" t "Newtonian", \
     "../bubble-axi-reduced/log" u 3:6 w l lw 2 lc rgb "red" t "Newtonian, reduced gravity", \
     "log" u 3:6 w l lw 2 lc rgb "sea-green" t "Visco-plastic"
~~~

~~~gnuplot Time evolution of the bubble volume
set key top right
set ylabel "V"
plot "../bubble-axi/log" u 3:4 w l lw 2 lc rgb "blue" t "Newtonian", \
     "../bubble-axi-reduced/log" u 3:4 w l lw 2 lc rgb "red" t "Newtonian, reduced gravity", \
     "log" u 3:4 w l lw 2 lc rgb "sea-green" t "Visco-plastic"
~~~

~~~gnuplot Bubble shape at the final time
reset
plot '../bubble-axi/out' u 1:2 w l lc rgb "blue" t "Newtonian", \
     '../bubble-axi-reduced/out' u 1:2 w l lc rgb "red" t "Newtonian, reduced gravity", \
     'out' u 1:2 w l lc rgb "sea-green" t "Visco-plastic"
~~~
