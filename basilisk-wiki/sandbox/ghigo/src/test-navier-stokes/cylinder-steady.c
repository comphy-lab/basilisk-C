...
increase of the error, compared to the test case
[cylinder-steady.c](../test-stokes/cylinder-steady.c). This is, in my
opinion, the propagation of errors made in small cells when using the
variable *divfnc* in the function
[update_tracer](../myembed.h#update_tracer). This errors could be
reduced by using a slope limiter for the gradient of the velocity or
by decreasing the timestep.
