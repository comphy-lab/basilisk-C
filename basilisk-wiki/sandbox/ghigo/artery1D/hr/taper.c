...
and flow rate $q$ at $t={0, 0.5, 1., 1.5, 2., 2.5}$ for $N=128$.

~~~gnuplot $a/a_0$ for $N=128$. 
reset
set xlabel 'x'
set ylabel '(a - a_0)/a_0'
plot '< cat fields-0.0-pid-*' u 1:4 w l lw 2 lc rgb "blue" t 't=0', \
...
set xlabel 'x'
set ylabel 'q'
plot '< cat fields-0.0-pid-*' u 1:5 w l lw 2 lc rgb "blue" t 't=0', \
