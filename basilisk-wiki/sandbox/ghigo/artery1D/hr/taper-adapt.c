...
plot '< cat ../taper/fields-0.0-pid-*' u 1:4 w l lw 3 lc rgb "black" t 'uniform', \
     '< cat ../taper/fields-0.5-pid-*' u 1:4 w l lw 3 lc rgb "black" notitle, \
     '< cat ../taper/fields-1.0-pid-*' u 1:4 w l lw 3 lc rgb "black" notitle, \
     '< cat ../taper/fields-1.5-pid-*' u 1:4 w l lw 3 lc rgb "black" notitle, \
     '< cat ../taper/fields-2.0-pid-*' u 1:4 w l lw 3 lc rgb "black" notitle, \
     '< cat ../taper/fields-2.5-pid-*' u 1:4 w l lw 3 lc rgb "black" notitle, \
...
set xlabel 'x'
set ylabel 'q'
plot '< cat ../taper/fields-0.0-pid-*' u 1:5 w l lw 3 lc rgb "black" t 'uniform', \
     '< cat ../taper/fields-0.5-pid-*' u 1:5 w l lw 3 lc rgb "black" notitle, \
     '< cat ../taper/fields-1.0-pid-*' u 1:5 w l lw 3 lc rgb "black" notitle, \
     '< cat ../taper/fields-1.5-pid-*' u 1:5 w l lw 3 lc rgb "black" notitle, \
     '< cat ../taper/fields-2.0-pid-*' u 1:5 w l lw 3 lc rgb "black" notitle, \
     '< cat ../taper/fields-2.5-pid-*' u 1:5 w l lw 3 lc rgb "black" notitle, \
