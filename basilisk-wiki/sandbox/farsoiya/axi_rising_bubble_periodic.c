...
<table>
<tr>
<td>![](axi_rising_bubble_periodic/final-1.png){ width="200px" }</td>
<td>![](axi_rising_bubble_periodic/final-2.png){ width="200px" }</td>
<td>![](axi_rising_bubble_periodic/final-3.png){ width="200px" }</td>
<td>![](axi_rising_bubble_periodic/final-4.png){ width="200px" }</td>
</tr>
<tr>
...
@article{farsoiya2020,
  ...
  year = {2021},
  note = {in Press},
  url = {https://hal.archives-ouvertes.fr/hal-03227997/document}
}
...
event acceleration (i++) {
  ...
  foreach_face(x)
    av.x[] += gravity*(-1. + alphav.x[]*rho1/max(y,1e-20));
