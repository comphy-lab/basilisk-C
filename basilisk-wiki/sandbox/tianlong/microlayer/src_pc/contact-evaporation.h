...
This file is the copy of [contact.h](/src/contact.h) which
allows the contact angle model to be used also in phase
change simulations.
...
//to compute the height after the advection of the interface
