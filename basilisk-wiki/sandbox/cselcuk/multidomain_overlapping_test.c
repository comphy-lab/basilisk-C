/**
# Two overlapping cylinders freely rotating in a sheared-flow with DLMFD
*/

/** Two cylinders, overlapping each other and twice as heavy as the
surrounding fluid, are freely rotating in a shear-flow.

We place the cylinders this way to test the method. */
...
# define UxAdaptCrit 2.5e-3
# define UyAdaptCrit 2.5e-3
# endif
...
event init (i = 0) {
  ...
  if (!restore (file = "dump")) {
	...
	gp.radius   = diam/2;
      ...
      /* initial condition: particle's angular velocity */
      coord c = {0., 0., 0.};
      p[k].w = c;
    }
...
set xlabel "time"
set ylabel "Tz"
plot "sum_lambda-0" u 1:4 w l, "sum_lambda-1" u 1:4 w l
...
<source src="multidomain_overlapping_test/movie.mp4" type="video/mp4">
</video>

## Streamwise velocity u.x
<video width="890" height="862" controls>
<source src="multidomain_overlapping_test/movie1.mp4" type="video/mp4">
</video>

## Fictitious domains of the particles
<video width="890" height="862" controls>
<source src="multidomain_overlapping_test/movie2.mp4" type="video/mp4">
</video>
*/
