...
set logscale x
set yrange [0:1.5]
set xlabel "Bond number Bo"
set ylabel "Dimensionless width e*"
set grid

plot "e_theta_130.dat" u 1:2 w lp title "Numerical", \
        1. w l lc rgb "black" dt 2 title "Theoretical geometric thickness", \
        [1e-3:1e2] e_inf(x) w l lc rgb "black" dt 3 title "Thickness due to gravity"
...
*/
  ...
  contact_angle = c;
/*
The Bond number is varied to vary the influence of the gravity.
*/
...
/**
## Gravity 
The gravity is set to vary with the Bond number to see its influence on teh sessile shape.
*/
