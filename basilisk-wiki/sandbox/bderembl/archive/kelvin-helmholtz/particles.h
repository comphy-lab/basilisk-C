...
bool P_RK3 = true;        //Switch for RK-3 scheme
/**
## Particle methods
...
#if _MPI
/**
   `Interpolate_array` is convinient. We re-implement it, assuming all
   local particles.
*/
...
/**
## Tests 
* [A quality test for the advection scheme](parttest.c)
