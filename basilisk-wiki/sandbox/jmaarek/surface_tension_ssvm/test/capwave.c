...
plot '../prosperetti.h' u 2:4 w l t "Prosperetti", \
     'capwave-7-1' w l t "{/Symbol D} t = 1 {/Symbol D} t_{ST}, SSVM", \
     'capwave-7-2' w l t "{/Symbol D} t = 2 {/Symbol D} t_{ST}, SSVM", \
     'capwave-7-4' w l t "{/Symbol D} t = 4 {/Symbol D} t_{ST}, SSVM", \
     'capwave-7-8' w l t "{/Symbol D} t = 8 {/Symbol D} t_{ST}, SSVM", \
     'capwave-7-15' w l t "{/Symbol D} t = 15 {/Symbol D} t_{ST}, SSVM"
