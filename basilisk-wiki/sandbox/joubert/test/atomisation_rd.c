...
/** 
We remove non resolved fragments of `f`.
*/
...
![Atomisation of a pulsed liquid jet.](atomisation/movie.mp4)(width="800" height="600")
...
Delta = 3./2**10 # minimum cell size
minvol = log10(Delta**2) # minimum cell volume
