...
Adapt mesh momentum conserving option test.
...
This is now the case as illustrated in the figure below.

![Concentration field at $t = 0.5$](vof-tracer-conserving-adapt/c.png)
