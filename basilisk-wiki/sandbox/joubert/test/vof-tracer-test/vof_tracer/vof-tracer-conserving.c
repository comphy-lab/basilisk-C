...
This is nearly the case as illustrated in the figure below.

![Concentration field with momentum conserving option at $t = 0.5$](vof-tracer-conserving/c.png)
