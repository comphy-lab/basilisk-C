...
We assume quadratic bottom friction with coefficient $C_f=2.5 \times 10^{-3}$. Wind stress $\tau$ is defined by the formula $\frac{\tau}{\rho} = C_{10} U_{10}^2,
$
...
$\frac{\tau}{\rho_{air}} = 0.145 m^2/s^2$ and thus $\frac{\tau}{\rho_{water}} = 1.7 \times 10^{-4} m^2/s^2$.  
 */
...
the size of the box `L0` is 1000 m and the coordinates of the lower-left corner
`(X0,Y0)` are (-500,-500). 
