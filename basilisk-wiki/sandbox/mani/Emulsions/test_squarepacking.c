/**
## Square close packing of droplets using [dense packing geometry
function](close-packing.h) 

![Square close packing of the
droplets](test_squarepacking/packing.png)
 */
...
#define NUMY 9 // Number of droplets in y direction
#define PK 1 // Hexagonal packing is 2 and Square packing is 1
#define I0 1.*D // Distance between bottom to the center of bottom
		// most droplets
...
## Results
   ...
   set xlabel 'f'
   set ylabel 'y/LENGTH'
   plot 'out' u 2:($1/10.8475) w lp pt 6 ps 0.7 notitle
   ~~~
