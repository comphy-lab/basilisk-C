...
We have discussed that the differentiation matrix is at the core of our tool. In ost of the code, we use a spectral discretisation based on Chebychev polynomials. This is customary in studies of fluid stability problems since the shape of the variables are typically smooth, and spectral discretization is very good for smooth problems. It was developped in the [Matlab differentiation matrix suite](http://dip.sun.ac.za/~weideman/research/differ.html) by Weigdeman & Reddy. You will find together with it many nice ways to build differentiation matrices for other spectral discretization. We use it extensivelly in easystab.
%}
