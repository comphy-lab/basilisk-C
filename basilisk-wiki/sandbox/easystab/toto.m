...
figure(1);hold off;
subplot(2,1,1);
plot(real(stheory),imag(stheory),'ro');xlim([-25,0]);
hold on;
...
%{
![**Figure :** The eigenvalues and eigenvectors](diffusion_eigenmodes/diffusion_eigenmodes1.svg)
%}

INTERACTIVE = isempty(getenv('OCTAVE_AUTORUN'));
%INTERACTIVE = false; %provisory solution
if (INTERACTIVE)
