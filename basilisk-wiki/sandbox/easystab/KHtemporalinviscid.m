...
title({['Temporal spectrum for k = ',num2str(alpha)], 'Click on eigenvalues to see the eigenmodes'});
 ...
 print('-dsvg','-r80','KH_temporal_inviscid_spectrum.svg');
%{
![** Figure : Temporal spectrum of a tanh shear layer](KH_temporal_inviscid/KH_temporal_inviscid_spectrum.svg)
%} 
...
pause(0.1);
%set(gcf,'paperpositionmode','auto');
print('-dsvg','KHtemporalinviscidmode.svg');

%{
![** Figure : Unstable eigenmmode of the tanh shear layer for k=0.5](KHtemporalinviscid/KHtemporalinviscidmode.svg)
%} 
...
if loopk
    ...
    set(gcf,'paperpositionmode','auto');
    print('-dsvg','-r80','KH_temporal_inviscid.svg');
...
![** Figure : temporal growth rate as function of wavenumber for the Kelvin-Helmholtz instability of a tanh shear layer](KHtemporalinviscid/KH_temporal_inviscid.svg)
