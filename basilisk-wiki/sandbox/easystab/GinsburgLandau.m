...
%{ 
![**Figure 1 :** The eigenvalues and eigenvectors](GinsburgLandau/Eigenmodes.png)
...
\sin (n \pi x / L ) ]  \quad (\mathrm{ with } n=1,2,...)
$$
...
of the first four modes according to linear theory](GinsburgLandau/Amplitudes_Linear.png)
...
\frac{\int_\Omega \left(\sum_{m=1}^\infty A_m(t) \hat \phi_m(x) \right)^{N_{nl}} \phi_n(x) dx}{\int_\Omega \phi_n(x)^2 dx} 
$$
...
$$
A_1(t) = \frac{r/\beta}{1+g_1 exp (-r t)} \quad \mathrm{ with }\, g_1
...
$$
A_1(t) = \frac{\sqrt{r/\beta}}{\sqrt{1+g_1 exp (-2 r t)}} \quad \mathrm{ with } \, g_1
...
of the amplitudes of the first four modes ](GinsburgLandau/Amplitudes_NonLinear.png)
...
NB : other versions of this program, used in 2018 and 2019, are available here:
 [/sandbox/easystab/david/GinsburgLandau_Linear.m]() and [/sandbox/easystab/david/GinsburgLandau_NonLinear_OneMode.m]()
