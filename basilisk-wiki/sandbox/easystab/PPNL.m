...
Two trajectrories, both ending ion the limit cycle, are drawn. Use the program interactively to draw more trajectories 
and/or study another model system !
](PhasePortrait_NonLinear/PhasePortraitNonLinear.png)
