...
We used the mode 1 as initial condition and we adapted the theoretical solution
...
for ind=1:Nt    
    ...
    e(ind)=interp1(x,q(f),L/4); % store center point
...
xlabel('time'); ylabel('f(L/4)');

%{
Here is the figure at time *tmax*:

![Validation](/Capture.png)
