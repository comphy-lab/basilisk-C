...
This is a copy of Antoon's [tracer-particles.h](Antoonvh/tracer-particles.h)
Adapted so to make it work with force-free particles in Stokesian regime.
For this purpose, the only real modification is turning off the
particle advection, that here is done using RK schemes...
### What I will have to do in the future:
Here particle velocity is computed interpolating it's value on the mesh.
In my case, I will obtain it using a force-free condition.
To be done.
*/
...
/**
# This is the part that I turn off for the moment...
*/
#ifdef ADVANCE_PARTICLE
...
/**
We need a ugly hack to access `ADD_PART_MEMBERS`, as they only become
available after the #define macros are processed.
 */
@define part p 
