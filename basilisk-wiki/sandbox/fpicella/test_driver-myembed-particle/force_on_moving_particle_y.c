...
coord imposedU = {0.0,1.0,0.0}; // externally imposed flow
...
set xlabel "Radius"
set ylabel "F_y"
set title "U_y=0, quiescent fluid"
...
plot '../../cylinder_between_plates/Dvinsky_Popel_1986_fig_02.dat' using ( $1):( $2) \
     ...
     'Particle_Forces.dat' using ( $4==0 && $1==7 ? $2 : 1/0 ):( $4==0  && $1==7 ? -$6 : 1/0 ) with points pt 7 ps 2 lc rgb "blue" title "lmax 7"
~~~
*/
