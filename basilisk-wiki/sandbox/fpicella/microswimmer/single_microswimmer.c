...
#include "fpicella/src/driver-particles-forces.h"
#include "view.h"
...
int main ()
{
  ...
  display_control(lmax,1,9);
	display_control(pIntensity,-10000,10000);
...
event particle (i++) // refresh particle's BC on embed at each iteration...!
{
/**
...
/**
	For the very first iterations, computation of
	velocity for force free produces oscillations.
	Those are not physical.
	I try to attenuate them like this... */
//	if(i<10)
//		foreach_particle()
//			foreach_dimension()
//				p().u.x *=0.1;
