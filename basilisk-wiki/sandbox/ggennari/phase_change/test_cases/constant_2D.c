...
We model a 2D dissolving bubble with constant mass transfer rate. A similar test can be found in Section 4.2 of [Gennari et al.,2022](#gennari2022).
...
This is the 2D version of the axisymmetric problem [constant_axi.c](/sandbox/ggennari/phase_change/test_cases/constant_axi.c).
*/
