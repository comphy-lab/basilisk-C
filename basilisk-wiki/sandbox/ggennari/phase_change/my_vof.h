/**
This is a copy of [vof.h](/src/vof.h). We changed the refinement/prolongation operator for tracer fields since we experienced compatibility issues between the vof_concentration_refine function and diffusion of tracers (with AMR). This must be investigated.
*/
...
static void sweep_x (scalar c, scalar cc, scalar * tcl)
{
  ...
  foreach_face(x, reduction (max:cfl)) {
    ...
    ![Volume fraction flux](/src/figures/flux.svg)
